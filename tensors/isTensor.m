...
%
%   The function actualy returns true if the input value 'tsr' has less dimensions than specified by 'order'. It means 
%   that, for example, if we specify 'order' 3, the function will return true if 'tsr' is a scalar, vector, matrix or a 
