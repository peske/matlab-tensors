function tests = tensorHadamard_2_test()
%TENSORHADAMARD_1_TEST Unit test of 'tensorHadamard' against equation 2.
%   The test is based on equation 2 from tensorHadamard_tests.md file.
